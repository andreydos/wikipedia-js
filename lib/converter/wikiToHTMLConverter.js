...
function convertLineToHTML(line, lang) {
    ...
    line = line.replace(CITATION_REFERENCE_REGEX, "");
    ...
    line = line.replace(HEADING_REGEX, "");
    ...
    line = line.replace(SINGLE_BRACKET_LINK_REGEX, "");
    ...
    line = line.replace(SPECIAL_LANGUAGE_INFO_REGEX, "");
    ...
    line = line.replace(REFERENCE_REGEX, "");
